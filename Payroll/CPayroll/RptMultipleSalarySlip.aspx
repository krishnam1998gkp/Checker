                ...
                <head runat="server">
                    ...
                    <%--<script language="javascript" src="JavaFiles/ProcessBar.js" type="text/javascript"></script>--%>
                        <script language="javascript" src="JavaFiles/ProcessBarWithoutPasswd.js?v=1.0.2"
                            type="text/javascript"></script>
                        <script language="javascript" src="JavaFiles/PaySlipsProcessBar.js?v=1.0.34"
                            type="text/javascript"></script>
                        <script language="javascript" src="JavaFiles/CommonDownload.js?v=1.0.1"
                            type="text/javascript"></script>
                        <script language="javascript" src="JavaFiles/ReportApiProgressBarScript.js?v=1.0.11"
                            type="text/javascript"></script>
                        <style type="text/css">
                            .btnGreen {
                                cursor: pointer;
                    ...
                    <%-- Payslips Progress bar div --%>
                        <div id="dlg" style="font-size: 1.1em; padding: 20px; display: none" title="Progress">
                            ...
                            <div id="summaryWrapper" style="display: none; line-height: 30px; padding-left: 10px;">
                                ...
                                <div id="emailSummary"
                                    style="display: none; line-height: 12px;height: 40px; overflow: auto; margin-top: 2px;">
                                                                                                                    ...
                                                                                                                    <tr id="trSftpID"
                                                                                                                        ...
                                                                                                                        <td
                                                                                                                            ...
                                                                                                                            <asp:CheckBox
                                                                                                                                ...
                                                                                                                                runat="server"
                                                                                                                                CssClass="Checkbox"
                                                                                                                                onchange="javascript:return OnLoadDataBind();"
                                                                                                                                AutoPostBack="false" />
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <table
                                                                                                                            ...
                                                                                                                            <tr id="Tr4"
                                                                                                                                ...
                                                                                                                                <td
                                                                                                                                    ...
                                                                                                                                    <input
                                                                                                                                        type="hidden"
                                                                                                                                        id="report_service_url"
                                                                                                                                        name="report_service_url"
                                                                                                                                        runat="server"
                                                                                                                                        value="N" />
                                                                                                                                    <input
                                                                                                                                        type="hidden"
                                                                                                                                        id="report_service_file_name"
                                                                                                                                        name="report_service_file_name"
                                                                                                                                        runat="server"
                                                                                                                                        value="" />
                                                                                                                                </td>
                                                                                                                            </tr>
