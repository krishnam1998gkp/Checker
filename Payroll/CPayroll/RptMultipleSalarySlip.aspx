...
<%@ Register Src="~/CPayroll/UsearchWithMultipleEmpCodeproxy.ascx" TagName="UserControl"
    TagPrefix="UC" %>
...
<head runat="server">
    ...
    <script language="javascript" src="JavaFiles/jquery-ui-1.8.1.custom.min.js" type="text/javascript"></script>
    ...
    function btnPreview_Click() {
        ...
        //Added by Debargha on 17-May-2024 for 'Please Wait' clickbait in case of other payslip report_types
            ...
            if ($('#tblpaycode').css('display') != 'none') {
                ...
                { return confirm('You have selected only deduction type paycode. If there is no any values according to the selection report will not appear. Do you want continue!') }
                else if (count > 0 && count1 <= 0)
                { return confirm('You have selected only addition type paycode. If there is no any values according to the selection report will not appear. Do you want continue!') }
                else return true;
            }
        }
    }
...
<body bottommargin="0" bgcolor="#f7fcff" leftmargin="0" topmargin="0" rightmargin="0"
    ...
    <div id="dlg" style="font-size: 1.1em; padding: 20px; display: none" title="Progress">
        ...
        <div id="statusWrapper" style="display: block; line-height: 30px; padding-left: 10px;">
            ...
            <div>
                <span>Estimated time left: </span><span id="estimatedTimeLeft" style="font-weight: bold"></span>
            </div>
        </div>
        <div id="summaryWrapper" style="display: none; line-height: 30px; padding-left: 10px;">
            ...
            <div>
                <span>Total employees whose slips successfully published : </span><span id="totalProcessedSlips"
                    style="font-weight: bold"></span>
            </div>
            <div>
                <span>Total employees whose slip not published due to some error: : </span><span id="totalUnprocessedSlips"
                    style="font-weight: bold"></span>
            </div>
            <div>
    ...
    <div id="CommonProgressBarModelElement" class="alt-module-true" style="display: none;">
        <div class="alt-modal dialog-500">
            ...
            <div class="alt-modal-body" id="CommonProgressBarStatusWrapper" style="display: block;">
                ...
                <div class="clearfix">
                    <span class="FL"><span class="blue-color" id="totalProcessedExcel"></span><span class="blue-color"
            ...
            <div id="CommonProgressBarFooter" class="alt-modal-body">
                <button id="CommonProgressBarCloseBtn" class="Btn" style="height: 20px; width: 55px; font-family: Verdana,Arial,sans-serif" onclick="hideModal();">Close</button>
            </div>
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <fieldset class="fieldset">
                                            <legend class="legend">Monthly Salary Slip Generation</legend>
                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                <tr>
                                                    <td align="left">
                                                        <table cellspacing="0" cellpadding="0" width="96%" align="center" border="0">
                                                            <tr>
                                                                <td class="tdcaption">
                                                                    <asp:RadioButton ID="rbtnslip" runat="server" CssClass="radio" Text="Salary Slip Report"
                                                                        GroupName="check" Onclick="rbtnChange('R')" AutoPostBack="false" />
                                                                    <asp:RadioButton ID="rbtnmail" runat="server" CssClass="radio" Text="E-Mail Payslip,TDS-Estimation Slip"
                                                                        Onclick="rbtnChange('M')" GroupName="check" AutoPostBack="false" />
                                                                ...
                                                                <td class="tdcaption" colspan="2">
                                                                    <%--<asp:UpdatePanel ID="upStatus" runat="server">
                                                                        <ContentTemplate>--%>
                                                                            <table cellspacing="0" cellpadding="0" width="98%" align="center" border="0" id="divSocial" runat="server" style="display: none;">
                                                                                <tr>
                                                                                    <td align="right">
                                                                                        <img src="Images/icon3.png" id="Img1" style="vertical-align: middle;" />
                                                                                        <%--<asp:Label ID="lblProcessStatus" runat="server" CssClass="UserStatusMsg" Text=""></asp:Label>--%>
                                                                                        <asp:Label ID="lblProcessStatus" runat="server" CssClass="UserStatusMsg" Text="" style="color: red"></asp:Label>
                                                                                        <asp:ImageButton ID="imgpdfprocess" runat="server" Style="vertical-align: middle;" Width="25px" ToolTip="Refresh" AlternateText="Refresh" ImageUrl="img/refreshtds.gif"></asp:ImageButton>
                                                                                        <%--<asp:ImageButton ID="imgpdfprocess" runat="server" Visible="true" Style="vertical-align: middle;" ToolTip="Refresh" AlternateText="Refresh" ImageUrl="img/refresh.gif"></asp:ImageButton>--%>
                                                                                        <asp:HiddenField ID="hdnusername" runat="server" Value="User" />
                                                                                        <asp:HiddenField ID="IsShowlnkIcon" runat="server" Value="N" />
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                       <%-- </ContentTemplate>
                                                            ...
                                                            <tr id="divSocialExcel" runat="server" visible="false">
                                                                <td colspan="3">
                                                                    <table cellspacing="0" cellpadding="0" width="98%" align="center" border="0">
                                                                        <tr>
                                                                            <td align="right">
                                                                                <img src="Images/icon3.png" id="ImgExcel" style="vertical-align: middle;" />
                                                                                <asp:Label ID="lblProcessStatusExcel" runat="server" CssClass="UserStatusMsg" Text=""></asp:Label>
                                                                                <%--<asp:Button ID="btnProgressbarExcel" runat="server" Text="click here to check progress" CssClass="CustomBtn" Width="175px" CausesValidation="False" OnClientClick="return PleaseWaitWithDailog();" />--%>
                                                                                <asp:ImageButton ID="btnProgressbarExcel" runat="server" Style="vertical-align: middle;" Width="25px" ToolTip="click here to check progress" AlternateText="Refresh" ImageUrl="img/refreshtds.gif" OnClientClick="return PleaseWaitWithDailog();"></asp:ImageButton>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td colspan="3" id="TdSearch">
                                                                    <UC:UserControl ID="USearch" runat="server" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="3">
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tr>
                                                                            ...
                                                                            <td width="31%">
                                                                                <asp:DropDownList ID="ddlMonthYear" runat="server" CssClass="dropdownlist" OnChange="popluateoffcycledate();">
                                                                                </asp:DropDownList>
                                                                            </td>
                                                                            <td class="tdcaption" width="10%">
                                                                                Hold-Type
                                                                            </td>
                                                                            <td class="tdcolon" align="center">
                                                                                :
                                                                            </td>
                                                                            <td>
                                                                                <asp:DropDownList ID="ddlshowsal" runat="server" CssClass="Dropdownlist">
                                                                                    <asp:ListItem Value="A">All</asp:ListItem>
                                                                                    <asp:ListItem Value="H">Only Withheld</asp:ListItem>
                                                                                    <asp:ListItem Value="N">Without Withheld</asp:ListItem>
                                                                                </asp:DropDownList>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                            ...
                                                            <tr id="SlipRegPre" runat="server">
                                                                <td align="left" colspan="3">
                                                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                                        <ContentTemplate>
                                                                            <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="tdvd">
                                                                                        <asp:DropDownList ID="DDLPaySlipType" runat="server" CssClass="dropdownlist" AutoPostBack="true">
                                                                                        </asp:DropDownList>
                                                                                        *
                                                                                    </td>
                                                                                </tr>
                                                                                <tr id="trShowClr" runat="server" style="display: none">
                                                                                    <td class="tdcaption" width="12%">
                                                                                        Show color on excel
                                                                                    </td>
                                                                                    <td class="tdcolon">
                                                                                    ...
                                                                                    <td class="TDVd" valign="top">
                                                                                        <asp:RadioButtonList ID="rbtshowclr" runat="server" CssClass="chkList" RepeatColumns="2">
                                                                                            <asp:ListItem Text="No" Value="N" Selected="True"></asp:ListItem>
                                                                                            <asp:ListItem Text="Yes" Value="Y"></asp:ListItem>
                                                                                        </asp:RadioButtonList>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr id="troffcycle" runat="server" style="display: none;">
                                                                                    <td class="tdcaption" width="12%">
                                                                                        Select Offcycle Date
                                                                                    </td>
                                                                                    <td class="tdcolon">
                                                                                        :
                                                                                    </td>
                                                                                    <td class="tdvd">
                                                                                        <asp:DropDownList ID="ddlmonthyearS" runat="server" CssClass="dropdownlist">
                                                                                        </asp:DropDownList>
                                                                                        *
                                                                                    </td>
                                                                                </tr>
                                                                                <tr id="trHelp" runat="server" style="display: none;">
                                                                                    ...
                                                                                    <td class="tdvd">
                                                                                        <asp:CheckBox runat="server" ID="chkHelp" CssClass="Checkbox" />
                                                                                    </td>
                                                                                </tr>
                                                                                <tr id="trrepformat" runat="server" style="display: none">
                                                                                    <td class="Tdcaption">
                                                                                        Report Format
                                                                                    </td>
                                                                                    <td class="TdColon">
                                                                                    ...
                                                                                    <td class="tdvd" colspan="5">
                                                                                        <asp:DropDownList ID="ddlformat" runat="server" CssClass="dropdownlist">
                                                                                        </asp:DropDownList>
                                                                                        *
                                                                                        <asp:RadioButton ID="rbHorizontal" runat="server" CssClass="Radio" Checked="True"
                                                                                            GroupName="Group" Text="Horizontal Format"></asp:RadioButton><asp:RadioButton ID="RbVertical"
                                                                                                runat="server" CssClass="Radio" GroupName="Group" Text="Vertical Format">
                                                                                        </asp:RadioButton>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr runat="server" id="trGroupBY" style="display: none">
                                                                                    <td class="Tdcaption" valign="top" width="12%">
                                                                                        Group By
                                                                                    </td>
                                                                                    <td class="TdColon" valign="top">
                                                                                        :
                                                                                    </td>
                                                                                    <td width="87%">
                                                                                        <table border="0" width="80%" cellpadding="0" cellspacing="0">
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <table border="0" width="33%" cellpadding="0" cellspacing="0" id="trsortbasis" runat="server"
                                                                                                        style="display: none">
                                                                                                        <tr>
                                                                                                            <td class="Tdcaption" valign="top" width="12%">
                                                                                                                Group By(1)
                                                                                                            </td>
                                                                                                            <td class="TdColon" valign="top" width="2%">
                                                                                                                :
                                                                                                            </td>
                                                                                                            <td class="tdvd" valign="top" colspan="5">
                                                                                                                <asp:DropDownList ID="ddlshortbasis" runat="server" CssClass="DropdownList" AutoPostBack="True">
                                                                                                                </asp:DropDownList>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        <tr runat="server" id="TRDIV">
                                                                                                            <td class="Tdcaption" valign="top">
                                                                                                                List
                                                                                                            </td>
                                                                                                            <td class="TdColon" valign="top">
                                                                                                                :
                                                                                                            ...
                                                                                                            <td class="tdcaption" valign="top">
                                                                                                                <div class="tdcolon" id="dlist" style="border-right: #003399 1px solid; border-top: #003399 1px solid;
                                                                                                                    overflow: auto; border-left: #003399 1px solid; width: 200px; border-bottom: #003399 1px solid;
                                                                                                                    height: 95px">
                                                                                                                    <%=getdatalist()%></div>
                                                                                                                <input id="hiddls_id" type="hidden" name="hiddls_id" runat="server" />
                                                                                                                <input id="hidShortVal" type="hidden" name="hidShortVal" runat="server" />
                                                                                                                <input id="hiddls_count" type="hidden" name="hiddls_count" runat="server" />
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </table>
                                                                                                </td>
                                                                                                <td>
                                                                                                    <table border="0" width="33%" cellpadding="0" cellspacing="0" id="trsortbasis2" runat="server"
                                                                                                        style="display: none">
                                                                                                        <tr>
                                                                                                            <td class="Tdcaption" valign="top" width="12%">
                                                                                                                Group By(2)
                                                                                                            ...
                                                                                                            <td class="tdvd" valign="top" colspan="5">
                                                                                                                <asp:DropDownList ID="ddlGroup2" runat="server" CssClass="DropdownList" AutoPostBack="True">
                                                                                                                </asp:DropDownList>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td colspan="5" class="tdcaption" valign="top">
                                                                                                                <div class="tdcolon" id="Div1" style="border-right: #003399 1px solid; border-top: #003399 1px solid;
                                                                                                                    overflow: auto; border-left: #003399 1px solid; width: 200px; border-bottom: #003399 1px solid;
                                                                                                                    height: 95px">
                                                                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" id="Group2">
                                                                                                                        <tr>
                                                                                                                            <td align="left" class="TDCaptionBold">
                                                                                                                                <asp:CheckBox ID="chkAllGr1" runat="server" Checked="true" onclick="checkUncheckCheckBoxlixtChkBox('Div1' ,this , 'chkListGroup1');"
                                                                                                                                    CssClass="checkbox" />Select All
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                        <tr>
                                                                                                                            <td>
                                                                                                                                <asp:CheckBoxList ID="chkListGroup1" runat="server" RepeatDirection="Horizontal"
                                                                                                                                    RepeatColumns="1" CssClass="chkList">
                                                                                                                                </asp:CheckBoxList>
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                    </table>
                                                                                                ...
                                                                                                <td>
                                                                                                    <table border="0" width="34%" cellpadding="0" cellspacing="0" id="trsortbasis3" runat="server"
                                                                                                        style="display: none">
                                                                                                        <tr>
                                                                                                            <td class="Tdcaption" valign="top" width="12%">
                                                                                                                Group By(3)
                                                                                                            ...
                                                                                                            <td class="tdvd" valign="top" colspan="5">
                                                                                                                <asp:DropDownList ID="ddlGroup3" runat="server" CssClass="DropdownList" AutoPostBack="True">
                                                                                                                </asp:DropDownList>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td colspan="5" class="tdcaption" valign="top">
                                                                                                                <div class="tdcolon" id="Div2" style="border-right: #003399 1px solid; border-top: #003399 1px solid;
                                                                                                                    overflow: auto; border-left: #003399 1px solid; width: 200px; border-bottom: #003399 1px solid;
                                                                                                                    height: 95px">
                                                                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" id="Group3">
                                                                                                                        <tr>
                                                                                                                            <td align="left" class="TDCaptionBold">
                                                                                                                                <asp:CheckBox ID="chkAllGr2" runat="server" Checked="true" onclick="checkUncheckCheckBoxlixtChkBox('Div2' ,this , 'chkListGroup2');"
                                                                                                                                    CssClass="checkbox" />Select All
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                        <tr>
                                                                                                                            <td>
                                                                                                                                <asp:CheckBoxList ID="chkListGroup2" runat="server" RepeatDirection="Horizontal"
                                                                                                                                    RepeatColumns="1" CssClass="chkList">
                                                                                                                                </asp:CheckBoxList>
                                                                                                                                <input id="hidGroup1Count" type="hidden" name="hidGroup1Count" runat="server" />
                                                                                                                                <input id="hidGroup2Count" type="hidden" name="hidGroup2Count" runat="server" />
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                    </table>
                                                                                                                </div>
                                                                                ...
                                                                                <%--START: Added row by Rohtas Singh on 06 Dec 2017 for Monthly Salary Slip (MAX Life--%>
                                                                                <tr id="trRptformat" runat="server" style="display: none">
                                                                                    <td class="Tdcaption">
                                                                                        Report Format
                                                                                    </td>
                                                                                    <td class="TdColon">
                                                                                    ...
                                                                                    <td class="tdvd" colspan="5">
                                                                                        <asp:DropDownList ID="ddlRptFormat" runat="server" CssClass="dropdownlist">
                                                                                            <asp:ListItem Text="CSV" Value="1"></asp:ListItem>
                                                                                            <asp:ListItem Text="Excel" Value="2"></asp:ListItem>
                                                                                        </asp:DropDownList>
                                                                                    </td>
                                                                                </tr>
                                                                                <%--END: Added row by Rohtas Singh on 06 Dec 2017 for Monthly Salary Slip (MAX Life--%>
                                                                               
                                                                               
                                                                                <tr id="trling" runat="server" style="display: none">
                                                                                    <td class="Tdcaption">
                                                                                        Select Multilingual
                                                                                    </td>
                                                                                    <td class="TdColon">
                                                                                    ...
                                                                                    <td class="tdvd" colspan="5">
                                                                                        <asp:DropDownList ID="ddllingual" runat="server" CssClass="dropdownlist">
                                                                                        </asp:DropDownList>
                                                                                    </td>
                                                                                </tr>

                                                                                <tr id="trformat" runat="server" style="display: none">
                                                                                    <td class="TDCaption" width="12%">Report Format</td>
                                                                                    <td class="TdColon">:</td>
                                                                                    <td class="TDVd">
                                                                                        <asp:DropDownList CssClass="DropdownList" ID="ddlrepformat" runat="server" AutoPostBack="true">
                                                                                ...
                                                                                <tr id="trEncrType" runat="server" style="display: none">
                                                                                    <td class="TDCaption" width="12%">Encryption Type</td>
                                                                                    <td class="TdColon">:</td>
                                                                                    <td class="TDVd">
                                                                                        <asp:DropDownList CssClass="DropdownList" ID="ddllEncrType"  runat="server" Width="265px">
                                                                                            <asp:ListItem Text="Without Encryption" Value="WE" Selected="True"></asp:ListItem>
                                                                                            <asp:ListItem Text="With Encryption" Value="WP"></asp:ListItem>
                                                                                        </asp:DropDownList>
                                                                                    </td>
                                                                                </tr>
                                                                                 <tr id="trFileName" runat="server" style="display: none">
                                                                                     <td class="TDCaption" width="12%">Report Name</td>
                                                                                     <td class="TdColon">:</td>
                                                                                     <td class="tdvd">
                                                                                        <asp:TextBox id="txtrptName" runat="server" CssClass="TextBox txtEmpname keypressPasteNoSplCharAlwSomeSplChr" MaxLength="100" onchange="isValidFileName();" >
                                                                                        </asp:TextBox>

                                                                                     </td>
                                                                                 </tr>
                                                                                 <tr id="trSftpID" runat="server" style="display: none">
                                                                                ...
                                                                                <tr id="trview" runat="server" style="display: none">
                                                                                    <td colspan="3">
                                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <div id="P1" class="tab" style="border-width: 1px; width: 100%;" runat="server" onclick="return toggle();">
                                                                                                        Show/Hide Salary slip register Configuration</div>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr id="trsetting" runat="server" style="display: none;">
                                                                                                <td>
                                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                        <tr>
                                                                                                            <td align="left" colspan="3">
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td colspan="3" align="center">
                                                                                                                <asp:Button ID="Btnclick" runat="server" CssClass="btn" Text="Click Here to Change"
                                                                                                                    Width="140px" />
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        <tr>
                                                                                            ...
                                                                                            <tr id="trgap" runat="server" class="trupbtn">
                                                                                                <td>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="7">
                                                                                        <table id="tblothepaycode" runat="server" border="0" cellpadding="0" cellspacing="0"
                                                                                            width="100%" style="display: none">
                                                                                            <tr>
                                                                                                <td class="Tdcaption" width="12%">
                                                                                                    Display other type paycode
                                                                                                </td>
                                                                                                <td class="tdcolon" valign="top">
                                                                                                    :
                                                                                                </td>
                                                                                                <td colspan="2" valign="top">
                                                                                                    <asp:CheckBox ID="chkother" runat="server" onclick="ShowHide(this)" CssClass="radio" />&nbsp;
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr id="tbl_QuestionTags_Software" style="display: none">
                                                                                                <td class="Tdcaption" width="12%">
                                                                                                </td>
                                                                                                <td class="tdcolon" valign="top">
                                                                                                </td>
                                                                                                <td width="12%" valign="top">
                                                                                                    <asp:CheckBox ID="chkAllot" runat="server" CssClass="cHKLIST" onclick="checkUncheckCheckBoxlixtChkBox('DivOther' ,this , 'Chklistothepaycode');"
                                                                                                        Text="Select All" />
                                                                                                    <td valign="top" align="left">
                                                                                                        <div id="DivOther" style="border-right: #003399 1px solid; border-top: #003399 1px solid;
                                                                                                            overflow: auto; border-left: #003399 1px solid; width: 100%; border-bottom: #003399 1px solid;
                                                                                                            height: 95px">
                                                                                                            <asp:CheckBoxList ID="Chklistothepaycode" runat="server" RepeatDirection="Horizontal"
                                                                                                                CssClass="chklist" CellPadding="0" CellSpacing="0" RepeatColumns="8">
                                                                                                            </asp:CheckBoxList>
                                                                                                        </div>
                                                                                                    </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td class="TRUpBtn" colspan="4">
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="3">
                                                                                        <table id="tblsection" cellspacing="0" cellpadding="0" width="100%" border="0" runat="server">
                                                                                            <tr>
                                                                                                <td class="tdcaption" colspan="6">
                                                                                                    View Format(Arrear OR W/O Arrear):
                                                                                                    <asp:DropDownList ID="ddlarrear" runat="server" CssClass="dropdownlist">
                                                                                                        <asp:ListItem Value="2">Format A (Arrear)</asp:ListItem>
                                                                                                        <asp:ListItem Value="1">Format B (W/O Arrear)</asp:ListItem>
                                                                                                    </asp:DropDownList>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td class="tdcaption" colspan="6">
                                                                                                    Would you like to see the following options on the Report:
                                                                                                    <asp:CheckBox ID="chkboxent" runat="server" Text="Entitlements"></asp:CheckBox>
                                                                                                    <asp:CheckBox ID="chkboxotherinc" runat="server" Text="Income from other sources">
                                                                                                    </asp:CheckBox>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td class="tdcaption" colspan="6">
                                                                                                    Select the following checkboxes under Chapter VI A as you would like to appear on
                                                                                                    Salary Slip:
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td class="Tdcaption">
                                                                                                    <asp:CheckBoxList ID="CBLsection" runat="server" CssClass="chkList">
                                                                                                    </asp:CheckBoxList>
                                                                                                    <input id="hdquery" type="hidden" runat="server" />
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="3">
                                                                                        <table id="tblpaycode" cellspacing="0" cellpadding="0" width="100%" runat="server">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td class="FormSubHeading">
                                                                                                        Addition Type Paycode<img alt="" title="Instruction" onclick="show('tb8');" src="ImagescA/new4-0985.gif"
                                                                                                            border="0" />
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="FormSubHeading">
                                                                                                        <input type="checkbox" checked="checked" id="ChkAddAll" onclick="checkUncheckCheckBoxlixtChkBox('AddPaycode',this,'cbladd')"
                                                                                                            class="chkList" text="All Addition">
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <div id="AddPaycode" style="border-right: #003399 1px solid; border-top: #003399 1px solid;
                                                                                                            overflow: auto; border-left: #003399 1px solid; width: 100%; border-bottom: #003399 1px solid;
                                                                                                            height: 95px">
                                                                                                            <asp:CheckBoxList ID="cbladd" runat="server" CssClass="chkList" RepeatDirection="Horizontal"
                                                                                                                RepeatColumns="9">
                                                                                                            </asp:CheckBoxList>
                                                                                                        </div>
                                                                                                    </td>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="FormSubHeading">
                                                                                                        <input type="checkbox" id="ChkDedAll" checked="checked" onclick="checkUncheckCheckBoxlixtChkBox('DedPaycode',this,'cbldeduction')"
                                                                                                            class="chkList" text="All Deduction">
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <div id="DedPaycode" style="border-right: #003399 1px solid; border-top: #003399 1px solid;
                                                                                                            overflow: auto; border-left: #003399 1px solid; width: 100%; border-bottom: #003399 1px solid;
                                                                                                            height: 50px">
                                                                                                            <asp:CheckBoxList ID="cbldeduction" runat="server" CssClass="chkList" RepeatDirection="Horizontal"
                                                                                                                RepeatColumns="9">
                                                                                                            </asp:CheckBoxList>
                                                                                                        </div>
                                                                                                    </td>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        <table id="Table5" cellspacing="0" cellpadding="0" width="20%" border="0">
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td valign="top">
                                                                                                                    <table class="Show" id="tb8" style="display: none" onclick="show('tb8');" cellspacing="1"
                                                                                                                        cellpadding="1" border="1">
                                                                                                                        <tr>
                                                                                                                            <td>
                                                                                                                                <asp:Label ID="Label1" runat="server">At Lest One Addtion and Deduction Type  Paycode Must Be Select</asp:Label>
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                    </table>
                                                                                                                </td>
                                                                                        ...
                                                                                        <table id="tblhelp" border="0" cellpadding="0" cellspacing="0" width="100%" runat="server">
                                                                                            <tr>
                                                                                                <td class="TRGap">
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr class="Message">
                                                                                                <td style="width: 2%;" valign="top">
                                                                                                    <img src="ImagesCA/helpbulb.gif" />
                                                                                                </td>
                                                                                                <td>
                                                                                                    <span style="color: Black; font-size: 11px; align: justify;"><b style="color: Red">Help:</b>
                                                                                                        Resister may not show correctly because pay components are hard coded.</span><span
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="3">
                                                                                        <table id="TblReimb" cellspacing="0" cellpadding="0" width="100%" runat="server"
                                                                                            style="display: none">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td class="FormSubHeading">
                                                                                                        Show Selected Reimbursement Seperately
                                                                                                        <img alt="" title="Instruction" onclick="show('TblReimbMsg');" src="ImagescA/new4-0985.gif"
                                                                                                            border="0" />
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="FormSubHeading">
                                                                                                        <input type="checkbox" id="ChkReimbAll" checked="checked" onclick="checkUncheckCheckBoxlixtChkBox('ReimbPaycode',this,'cblReimb')"
                                                                                                            class="chkList" text="All Reimbursement">
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <div id="ReimbPaycode" style="border-right: #003399 1px solid; border-top: #003399 1px solid;
                                                                                                            overflow: auto; border-left: #003399 1px solid; width: 100%; border-bottom: #003399 1px solid;
                                                                                                            height: 95px">
                                                                                                            <asp:CheckBoxList ID="cblReimb" runat="server" CssClass="chkList" RepeatDirection="Horizontal"
                                                                                                                RepeatColumns="9">
                                                                                                            </asp:CheckBoxList>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <table id="TblReimb2" cellspacing="0" cellpadding="0" width="20%" border="0">
                                                                                                            <tr>
                                                                                                                <td align="left" width="2%">
                                                                                                                </td>
                                                                                                                <td valign="top">
                                                                                                                    <table class="Show" id="TblReimbMsg" style="display: none" onclick="show('TblReimbMsg');"
                                                                                                                        cellspacing="1" cellpadding="1" border="1">
                                                                                                                        <tr>
                                                                                                                            <td>
                                                                                                                                <asp:Label ID="lblReimb" runat="server">Select at least one reimbursement paycode</asp:Label>
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                    </table>
                                                                                                                </td>
                                                                                    ...
                                                                                    <td colspan="3" align="center">
                                                                                        <div id="divgenerate" runat="server">
                                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                                                                                                <tr>
                                                                                                    <td class="Tdcaption" valign="top" width="12%">
                                                                                                        <input id="HidPreVal" type="hidden" runat="server" name="hidval" />
                                                                                                    </td>
                                                                                                    <td class="TdColon" valign="top"></td>
                                                                                                    <td>
                                                                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                                                                            <tr>
                                                                                                                <td valign="top">
                                                                                                                    <asp:Button ID="btnPreview" runat="server" CssClass="btn" Text="Preview" OnClientClick="javascript:return btnPreview_Click();" />
                                                                                                                    <asp:Button ID="btnExport2CSV" runat="server" CssClass="btn" Width="100px" Visible="false" Text="Export to CSV" OnClientClick="javascript:return btnPreview_Click();" />

                                                                                                                    <%--Added by Debargha on 17-May-2024--%>
                                                                                                                    <input id="hdfile" type="hidden" name="hdfile" runat="server" />
                                                                                                                    <input id="hdtdsfile" type="hidden" name="hdtdsfile" runat="server" />
                                                                                                                    <%--Added by Debargha on 17-May-2024--%>
                                                                                                                </td>
                                                                                                                <td class="tdbetweenbtn"></td>
                                                                                                                <td valign="top">
                                                                                                                    <asp:Button ID="btnresetsearch" runat="server" CssClass="btn" Text="Reset" />
                                                                                                                </td>
                                                                                                                <td class="tdbetweenlbl"></td>
                                                                                                                <td valign="top">
                                                                                                                    <asp:Label ID="lblmsg2" runat="server" CssClass="usermessage"></asp:Label>
                                                                                                                </td>
                                                                                                            </tr>

                                                                                                        </table>
                                                                                                        <asp:LinkButton ID="LinkButton2" runat="server"></asp:LinkButton>
                                                                                                        <input id="HidAdd" type="hidden" name="HidAdd" runat="server" />
                                                                                                        <input id="HidDed" type="hidden" name="HidDed" runat="server" />
                                                                                                        <input id="Hidothepaycode" type="hidden" name="HidPreVal" runat="server" />
                                                                                                        <input id="hidothrpaycode" type="hidden" name="HidPreVal" runat="server" />
                                                                                                        <input id="HidReimb" type="hidden" name="HidDed" runat="server" />
                                                                                                        <input id="hidGroup2Val" type="hidden" name="hidGroup2Val" runat="server" />
                                                                                                        <input id="hidGroup3Val" type="hidden" name="hidGroup3Val" runat="server" />
                                                                                                        <input type="hidden" id="JobUniqueId" name="JobUniqueId" runat="server" />
                                                                        ...
                                                                        <Triggers>
                                                                            <asp:PostBackTrigger ControlID="btnPreview" />
                                                                            <asp:PostBackTrigger ControlID="btnExport2CSV" />
                                                                            <asp:PostBackTrigger ControlID="btnProgressbarExcel" />
                                                                        </Triggers>
                                                                    </asp:UpdatePanel>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="tdcaption" colspan="3" align="center">
                                                                    <div id="divEmail" style="border-right: #003399 0px solid; border-top: #003399 0px solid;
                                                                                    ...
                                                                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                                        <ContentTemplate>
                                                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
                                                                                                <tr>
                                                                                                    <td colspan="3">
                                                                                                        <table id="Table6" width="100%" cellpadding="0" cellspacing="0" runat="server" border="0">
                                                                                                            <tr>
                                                                                                                <td class="tdcaption" width="27%">
                                                                                                                    Report Type
                                                                                                                </td>
                                                                                                                <td width="6%" style="color: Black; font-family: verdana; font-size: 11; text-align: left;">
                                                                                                                    :
                                                                                                                </td>
                                                                                                                <td class="TDVd">
                                                                                                                    <asp:DropDownList ID="DdlreportType" runat="server" CssClass="dropdownlist" Width="230px"
                                                                                                                        AutoPostBack="true">
                                                                                                                    </asp:DropDownList>
                                                                                                                    *&nbsp;&nbsp;<asp:Button ID="BtnPreviewdivActive" Style="display: none" runat="server"
                                                                                                                        BackColor="CadetBlue" CssClass="btn" Height="17px" Text="You can change the format of this report by clicking here."
                                                                                                                        ToolTip="You can change the format of this report by clicking here." Width="360px"
                                                                                                                        ForeColor="Blue" />
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                            <tr id="troffcycledt" runat="server" style="display: none;">
                                                                                                                <td class="tdcaption" width="12%">
                                                                                                                    Select Offcycle Date
                                                                                                                </td>
                                                                                                                <td class="tdcolon">
                                                                                                                ...
                                                                                                                <td class="tdvd">
                                                                                                                    <asp:DropDownList ID="ddloffcycledt" runat="server" CssClass="dropdownlist">
                                                                                                                    </asp:DropDownList>
                                                                                                                    *
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                            <tr id="trlingpdf" runat="server" style="display: none">
                                                                                                                <td class="Tdcaption">
                                                                                                                    Select Multilingual
                                                                                                                </td>
                                                                                                                <td class="TdColon">
                                                                                                                ...
                                                                                                                <td class="tdvd" colspan="5">
                                                                                                                    <asp:DropDownList ID="ddlmultilingual" runat="server" CssClass="dropdownlist">
                                                                                                                    </asp:DropDownList>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                ...
                                                                                                <tr id="trhelp1" runat="server" style="display: none;">
                                                                                                    <td colspan="3">
                                                                                                        <table width="100%" cellpadding="0" cellspacing="0">
                                                                                                            <tr>
                                                                                                                <td class="tdcaption" width="27%">
                                                                                                                ...
                                                                                                                <td class="tdcolon" style="width: 6%">
                                                                                                                    :
                                                                                                                </td>
                                                                                                                <td class="tdvd">
                                                                                                                    <asp:CheckBox runat="server" ID="chkHelp1" CssClass="Checkbox" />
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                    </td>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td colspan="3">
                                                                                                        <table id="tblrepin" width="100%" cellpadding="0" cellspacing="0" runat="server"
                                                                                                            border="0">
                                                                                                            <tr>
                                                                                                                <td class="tdcaption" width="27%">
                                                                                                                    Report In
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <asp:DropDownList ID="ddlRepIn" runat="server" CssClass="dropdownlist" AutoPostBack="true"
                                                                                                                        onchange="ShowRepDet();">
                                                                                                                    </asp:DropDownList>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                    ...
                                                                                                    <td colspan="3">
                                                                                                        <table id="tblsp" width="100%" cellpadding="0" cellspacing="0" runat="server">
                                                                                                            <tr>
                                                                                                                <td class="tdcaption" width="20%">
                                                                                                                    &nbsp;&nbsp;&nbsp;Salary Processed/Not
                                                                                                                </td>
                                                                                                                <td class="tdcolon" style="width: 6%" align="center">
                                                                                                                    :
                                                                                                                </td>
                                                                                                                <td>
                                                                                                                    <asp:DropDownList ID="ddlSalaryProcess" runat="server" CssClass="dropdownlist">
                                                                                                                        <asp:ListItem Selected="True" Value="Y">Processed</asp:ListItem>
                                                                                                    ...
                                                                                                    <td colspan="3">
                                                                                                        <table width="100%" cellpadding="0" cellspacing="0">
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td class="tdvd">
                                                                                                                    <asp:DropDownList ID="ddlEMailExist" runat="server" CssClass="dropdownlist">
                                                                                                                        <asp:ListItem Selected="True" Value="B">Both</asp:ListItem>
                                                                                                                        <asp:ListItem Value="Y">Exist</asp:ListItem>
                                                                                                                        <asp:ListItem Value="N">Not Exist</asp:ListItem>
                                                                                                                    </asp:DropDownList>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                    ...
                                                                                                    <td colspan="3" width="55%">
                                                                                                        <table width="100%" cellpadding="0" cellspacing="0">
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <asp:DropDownList ID="ddlEMailSend" runat="server" CssClass="dropdownlist">
                                                                                                                        <asp:ListItem Selected="True" Value="B">Both</asp:ListItem>
                                                                                                                        <asp:ListItem Value="Y">Mail Sent</asp:ListItem>
                                                                                                                        <asp:ListItem Value="N">Mail Not Sent</asp:ListItem>
                                                                                                                    </asp:DropDownList>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td colspan="3">
                                                                                                        <table id="tblSh" width="100%" cellpadding="0" cellspacing="0" runat="server">
                                                                                                            <tr>
                                                                                                                <td class="tdcaption" width="27%">
                                                                                                                    Salary On Hold/Not
                                                                                                                </td>
                                                                                                                ...
                                                                                                                <td class="tdvd">
                                                                                                                    <asp:DropDownList ID="ddlSalWithHeld" runat="server" CssClass="dropdownlist">
                                                                                                                        <asp:ListItem Value="Y">Salary Withheld</asp:ListItem>
                                                                                                                        <asp:ListItem Selected="True" Value="N">Salary Not Withheld</asp:ListItem>
                                                                                                                    </asp:DropDownList>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                    ...
                                                                                                    <td colspan="3" width="55%">
                                                                                                        <table id="tblpwd" width="100%" cellpadding="0" cellspacing="0" runat="server">
                                                                                                            <tr>
                                                                                                                <td class="tdcaption" width="20%">
                                                                                                                    &nbsp;&nbsp;&nbsp;PDF Password Type
                                                                                                                </td>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <asp:DropDownList ID="ddlEmpPass" runat="server" CssClass="dropdownlist" Enabled="true">
                                                                                                                        <asp:ListItem Text="No Password" Value="0"></asp:ListItem>
                                                                                                                        <asp:ListItem Text="Emp. Code" Value="3"></asp:ListItem>
                                                                                                                        <asp:ListItem Text="Pan No." Value="1"></asp:ListItem>
                                                                                                                        <asp:ListItem Text="First Name & DOB" Value="2"></asp:ListItem>
                                                                                                                        <asp:ListItem Text="Bank A/C No. & DOB" Value="4"></asp:ListItem>
                                                                                                                        <%--  <asp:ListItem Text="First Name & DOB(DDMMYYYY)" Value="5"></asp:ListItem>--%>
                                                                                                                    </asp:DropDownList>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                ...
                                                                                                <tr runat="server" id="trRepEmail">
                                                                                                    <td colspan="3">
                                                                                                        <table width="100%" cellpadding="0" cellspacing="0">
                                                                                                            <tr>
                                                                                                                <td class="tdcaption" width="27%">
                                                                                                                    Send pay slips in email to reporting manager
                                                                                                                </td>
                                                                                                                <td class="tdcolon" style="width: 6%">
                                                                                                                    :
                                                                                                                </td>
                                                                                                                <td class="tdvd">
                                                                                                                    <asp:CheckBox runat="server" ID="chkemailrepmanager"></asp:CheckBox>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                    </td>
                                                                                                    <td colspan="3" align="right">
                                                                                                        <table class="Message" width="100%" cellpadding="0" cellspacing="0">
                                                                                                            <tr>
                                                                                                                <td class="tdcaption">
                                                                                                                    <img src="ImagesCA/Note.gif" />
                                                                                                                </td>
                                                                                                                <td>
                                                                                                                    <span style="color: red"><b>Note:</b></span><span style="font-size: 7.5pt; color: Black;
                                                                                                                        ...
                                                                                                                        mso-bidi-language: AR-SA">&nbsp;</span> Enable the check box, if you want to
                                                                                                                    send pay slips to Reporting Manager. You can send PDF or HTML pay slip.
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr id="TrNoSearch" runat="server" style="display: none;">
                                                                                                    <td colspan="3">
                                                                                                        <table width="100%" cellpadding="0" cellspacing="0">
                                                                                                            <tr>
                                                                                                                <td class="tdcaption" width="27%">
                                                                                                                    Search Record(s) / Publish Record(s) Without Search
                                                                                                                </td>
                                                                                                                <td class="tdcolon" style="width: 6%">
                                                                                                                    :
                                                                                                                </td>
                                                                                                                <td class="tdvd">
                                                                                                                    <asp:RadioButtonList ID="RblNoSearch" runat="server" CssClass="Radio" AutoPostBack="true"
                                                                                                                        RepeatDirection="Horizontal" onchange="javascript:return PleaseWaitWithDailog();">
                                                                                                                        <asp:ListItem Text="Publish Payslip(s) Without Search" Value="P" Selected="True"></asp:ListItem>
                                                                                                                        <asp:ListItem Text="Search Record(s)" Value="S"></asp:ListItem>
                                                                                                                    </asp:RadioButtonList>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                            <tr id="trMerge" runat="server" style="display: none">
                                                                                                                ...
                                                                                                                <td class="tdvd">
                                                                                                                    <asp:CheckBox ID="chkMerge" runat="server" Checked="false" CssClass="tdcaption" Text="<b>Merge Payslip</b>" />
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                    </td>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <span style="color: red"><b>Note:</b></span><span style="font-size: 7.5pt; color: Black;
                                                                                                                        line-height: 115%; font-family: Verdana; mso-fareast-font-family: 'Times New Roman';
                                                                                                                        mso-bidi-font-family: 'Times New Roman'; mso-ansi-language: EN-IN; mso-fareast-language: EN-US;
                                                                                                                        mso-bidi-language: AR-SA">&nbsp;</span><b>Search Record(s):</b> You can search
                                                                                                                    record(s) before sending mail, publish record(s) as zip file and publish and email
                                                                                                                    to CC / BCC.<br />
                                                                                                                    <b>Publish Record(s) Without Search:</b> You can directly publish record(s) as zip
                                                                                                                    file in pdf format without searching.
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                            <tr id="trMergeMsg" runat="server" style="display: none">
                                                                                                                <td class="tdcaption">
                                                                                                                    <img src="ImagesCA/Note.gif" />
                                                                                                                </td>
                                                                                                                <td>
                                                                                                                    <span style="color: red"><b>Note:</b></span><span style="font-size: 7.5pt; color: Black;
                                                                                                                        line-height: 115%; font-family: Verdana; mso-fareast-font-family: 'Times New Roman';
                                                                                                                        mso-bidi-font-family: 'Times New Roman'; mso-ansi-language: EN-IN; mso-fareast-language: EN-US;
                                                                                                                        mso-bidi-language: AR-SA">&nbsp;</span><b>Merge Payslip:</b> Select if you want
                                                                                                                    to publish the PDF tax report merged with Pay Slip With Leave Details.
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <%--START: Added by Quadir on 14 OCT 2020- Payslip Publish Mode (RadioButton)--%>
                                                                                                <tr id="TrSlipPubMode" runat="server" style="display: none;">
                                                                                                    <td colspan="3">
                                                                                                        <table width="100%" cellpadding="0" cellspacing="0">
                                                                                                            <tr>
                                                                                                                <td class="tdcaption" width="27%">
                                                                                                                    Payslip Publish Mode
                                                                                                                </td>
                                                                                                                <td class="tdcolon" style="width: 6%">
                                                                                                                    :
                                                                                                                </td>
                                                                                                                <td class="tdvd">
                                                                                                                    <asp:RadioButtonList ID="rbtSlipPubMode" runat="server" CssClass="Radio" AutoPostBack="true"
                                                                                                                        RepeatDirection="Horizontal" onchange="javascript:return PleaseWaitWithDailog();">
                                                                                                                        <asp:ListItem Text="Incremental" Value="I" Selected="True"></asp:ListItem>
                                                                                                ...
                                                                                                <%--END: Added by Quadir on 14 OCT 2020- Payslip Publish Mode (RadioButton)--%>
                                                                                                <tr id="TrGrpbyPublish" runat="server" style="display: none;">
                                                                                                    <td colspan="3">
                                                                                                        <table width="100%" cellpadding="0" cellspacing="0">
                                                                                                            <tr>
                                                                                                                <td class="tdcaption" width="27%">
                                                                                                                    Publish Slip(s) According to
                                                                                                                </td>
                                                                                                                <td class="tdcolon" style="width: 6%">
                                                                                                                    :
                                                                                                                </td>
                                                                                                                <td class="tdvd">
                                                                                                                    <asp:RadioButtonList ID="RblGrpbyPublish" runat="server" CssClass="Radio" AutoPostBack="true"
                                                                                                                        RepeatDirection="Horizontal" onchange="javascript:return PleaseWaitWithDailog();">
                                                                                                                        <asp:ListItem Text="Employee Wise" Value="" Selected="True"></asp:ListItem>
                                                                                                                        <asp:ListItem Text="Unit Wise" Value="UNT"></asp:ListItem>
                                                                                                                    </asp:RadioButtonList>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <span style="color: red"><b>Note:</b></span><span style="font-size: 7.5pt; color: Black;
                                                                                                                        line-height: 115%; font-family: Verdana; mso-fareast-font-family: 'Times New Roman';
                                                                                                                        mso-bidi-font-family: 'Times New Roman'; mso-ansi-language: EN-IN; mso-fareast-language: EN-US;
                                                                                                                        mso-bidi-language: AR-SA">&nbsp;</span><b>Employee Wise:</b> Publish salary
                                                                                                                    slip(s) for each employee separately.<br />
                                                                                                                    <b>Unit Wise:</b> Publish salary slip(s) unit wise as single zip file for each unit
                                                                                                                    and email to unit authority. <b>"PDF Password Type"</b> will not work in this condition.
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr id="trselall" style="display: none" runat="server">
                                                                                                    <td colspan="6">
                                                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                            <tr>
                                                                                                                <td width="45%" valign="top">
                                                                                                                    <asp:CheckBox ID="chkmailformat" runat="server" OnCheckedChanged="chkmailformat_CheckedChanged"
                                                                                                                        Checked="false" AutoPostBack="True" CssClass="tdcaption" Text="Select if you want to create Email body." />
                                                                                                                </td>
                                                                                                                <td width="70%">
                                                                                                                    <table class="Message" border="0" cellpadding="0" cellspacing="0" width="100%" align="right">
                                                                                                                        <tr>
                                                                                                                            <td valign="top">
                                                                                                                                <img src="ImagesCA/Note.gif" />
                                                                                                                            </td>
                                                                                                                            <td>
                                                                                                                                <span style="color: red"><b>Note:</b></span><span style="font-size: 7.5pt; color: Black;
                                                                                                                                    line-height: 115%; font-family: Verdana; mso-fareast-font-family: 'Times New Roman';
                                                                                                                                    mso-bidi-font-family: 'Times New Roman'; mso-ansi-language: EN-IN; mso-fareast-language: EN-US;
                                                                                                                                    mso-bidi-language: AR-SA">&nbsp;</span> Select if you want to create Email body.
                                                                                                                                (<span style="color: red"> <b>Custom message does not work</b></span> when you use
                                                                                                                                the option Publish and Email to CC/BCC because we can’t pick the empcode and other
                                                                                                                                fields which you use to define the custom message).
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                    </table>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                            <tr id="tblmail" runat="server" style="display: none">
                                                                                                                <td colspan="2">
                                                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                                        <tr>
                                                                                                                            <td colspan="8" valign="top" style="height: 36px">
                                                                                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                                                    <tr>
                                                                                                                                        <td>
                                                                                                                                            <%=_objCommon.makeHeading("Create Custom Email Message")%>
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                                                                                                </table>
                                                                                                                            </td>
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td class="tdvd" colspan="5">
                                                                                                                                <asp:TextBox ID="txtheader" CssClass="Textbox" runat="server" Width="519px" onblur="Javascript:return Clicked(this.id,'Y');"></asp:TextBox>*
                                                                                                                            </td>
                                                                                                                            <td class="tdvd">
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                        <tr>
                                                                                                                            <td class="trgap" colspan="8" valign="top">
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                        <tr>
                                                                                                                            <td class="tdcaption" valign="top" width="12%">
                                                                                                                            ...
                                                                                                                            <td class="tdvd" colspan="5" valign="top">
                                                                                                                                <div style="height: 225px">
                                                                                                                                    <cc1:EasyWebEdit ID="EasyWebMAilBody" runat="server" AllowFileUpload="True" FileManager="../"
                                                                                                                                        FileUploadDir="/tempattachment/" onclick="Clicked(this.id,'N');" ImagesLocation="../SAPayroll/WebEditorImg"
                                                                                                                                        Width="523px" Height="131px"></cc1:EasyWebEdit>
                                                                                                                                </div>
                                                                                                                                *
                                                                                                                            </td>
                                                                                                                            <td class="tdcaption" valign="top">
                                                                                                                                <asp:ListBox ID="lsthelp" runat="server" CssClass="dropdownlist" Height="100px" ondblclick="Javascript:return DblClicked(this.form);"
                                                                                                                                    Width="227px">
                                                                                                                                    <asp:ListItem Text="Employee Code:[EMPCODE]" Value="[EMPCODE]"></asp:ListItem>
                                                                                                                                    <asp:ListItem Text="Employee Name:[EMPNAME]" Value="[EMPNAME]"></asp:ListItem>
                                                                                                                                    <asp:ListItem Text="Company Name:[COMPNAME]" Value="[COMPNAME]"></asp:ListItem>
                                                                                                                                    <asp:ListItem Text="Company Address :[COMPADDRESS]" Value="[COMPADDRESS]"></asp:ListItem>
                                                                                                                                    <asp:ListItem Text="Month :[MONTH]" Value="[MONTH]"></asp:ListItem>
                                                                                                                                    <asp:ListItem Text="Year :[YEAR]" Value="[YEAR]"></asp:ListItem>
                                                                                                                                    <asp:ListItem Text="Click hear to add Break[BR]" Value="&lt;BR&gt;"></asp:ListItem>
                                                                                                                                </asp:ListBox>
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                        <tr>
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td class="tdvd" colspan="6" valign="top">
                                                                                                                                <asp:TextBox ID="Textfooter" CssClass="Textbox" runat="server" Width="519px" onblur="Javascript:return Clicked(this.id,'Y');"></asp:TextBox>*
                                                                                                                                <asp:Button ID="Btndelete" runat="server" CssClass="btn" Width="120px" Text="Delete Mail Content"
                                                                                                                                    OnClientClick="javascript:return ConfirmDelete('Would you like to delete Mail Format.');" />
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                        <tr>
                                                                                                                            <td class="trupbtn" colspan="8" valign="top">
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                    </table>
                                                                                                                </td>
                                                                                ...
                                                                                <td class="tdcaption" colspan="6">
                                                                                    <asp:UpdatePanel ID="updMail" runat="server">
                                                                                            ...
                                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                    ...
                                                                                                    <td>
                                                                                                        <table border="0" cellpadding="3" cellspacing="0" width="100%">
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td class="TdColon" valign="top" width="3%">
                                                                                                                </td>
                                                                                                                <td valign="top" style="width: 30%">
                                                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="80%">
                                                                                                                        <tr>
                                                                                                                            <td id="TdSearch1" runat="server" valign="top" style="width: 27%">
                                                                                                                                <asp:Button ID="Btnsearch" runat="server" CssClass="btn" Text="Search" OnClientClick="javascript:return btnSearch_Click(this)" />
                                                                                                                            </td>
                                                                                                                            <td id="TdSearch2" runat="server" class="tdbetweenlbl" style="width: 1%">
                                                                                                                            </td>
                                                                                                                            <td valign="top">
                                                                                                                                <asp:Button ID="btnreset" OnClientClick="ResetCtrl();" class="btn" Text="RESET" runat="server" />
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                    </table>
                                                                                                                </td>
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td>
                                                                                                                                <span style="color: red"><b>Note:</b></span><span style="font-size: 7.5pt; color: Black;
                                                                                                                                    line-height: 115%; font-family: Verdana; mso-fareast-font-family: 'Times New Roman';
                                                                                                                                    mso-bidi-font-family: 'Times New Roman'; mso-ansi-language: EN-IN; mso-fareast-language: EN-US;
                                                                                                                                    mso-bidi-language: AR-SA">&nbsp;</span> You can now send zip file of the payslips
                                                                                                                                to the email id you mention in CC / BCC. You can ONLY send PDF payslip and not HTML.
                                                                                                                                First select PDF and then choose the option “Publish and email to CC / BCC”.
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                    </table>
                                                                                                                </td>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td colspan="2">
                                                                                                                    <div id="divlblMsg" style="overflow: auto; height: 40px; width: 100%">
                                                                                                                        <asp:Label ID="lblmsg" runat="server" CssClass="usermessage"></asp:Label>
                                                                                                                    </div>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                ...
                                                                                                <tr style="display: none">
                                                                                                    <td>
                                                                                                        ...
                                                                                                        <input id="HidRepId" runat="server" name="HidRepId" type="hidden" />
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr id="tableshow" runat="server" style="display: none">
                                                                                                    <td>
                                                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                            <tr id="TrDg" runat="server" style="display: none;">
                                                                                                                <td colspan="4">
                                                                                                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                                                                        <tr>
                                                                                                                            <td class="FormSubHeading" width="100%" colspan="4">
                                                                                                                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                                                                                    <%=_objCommon.makeHeading("List of Employee(s)")%>
                                                                                                                                </table>
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                        <tr>
                                                                                                                            <td>
                                                                                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                                                                                    <tr>
                                                                                                                                        <td>
                                                                                                                                            <asp:Label ID="LblL1" runat="server" Height="12px" Width="12px" Text="&nbsp;&nbsp;"
                                                                                                                                                BackColor="#ffc0cb"></asp:Label>
                                                                                                                                        </td>
                                                                                                                                        <td class="TDBetweenBtn">
                                                                                                                                        </td>
                                                                                                                                        <td class="TDCaption">
                                                                                                                                            <font color='#ffc0cb'>Either email id not available or salary withheld!</font>
                                                                                                                                        </td>
                                                                                                                                        <td class="TDBetweenBtn">
                                                                                                                                        </td>
                                                                                                                                        <td class="TDBetweenBtn">
                                                                                                                                        ...
                                                                                                                                        <td>
                                                                                                                                            <asp:Label ID="LblL2" runat="server" Height="12px" Width="12px" Text="&nbsp;&nbsp;"
                                                                                                                                                BackColor="#87ceeb"></asp:Label>
                                                                                                                                        </td>
                                                                                                                                        <td class="TDBetweenBtn">
                                                                                                                                        </td>
                                                                                                                                        <td class="TDCaption">
                                                                                                                                            <font color='#87ceeb'>Salary not processed or email already sent!</font>
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                                                                                                </table>
                                                                                                                            </td>
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            <td>
                                                                                                                                <div id="DvEmp">
                                                                                                                                    <asp:DataGrid ID="DgPayslip" runat="server" AutoGenerateColumns="False" CssClass="DataGridBody"
                                                                                                                                        DataKeyField="fk_emp_code" Width="100%">
                                                                                                                                        <SelectedItemStyle CssClass="DataGridSelectedItemStyle"></SelectedItemStyle>
                                                                                                                                        ...
                                                                                                                                        <Columns>
                                                                                                                                            <asp:TemplateColumn HeaderStyle-Width="3%">
                                                                                                                                                <HeaderTemplate>
                                                                                                                                                    <input id="Checkbox1" checked="checked" class="chk" onclick="checkUncheckGridCheckBox('DvEmp', this,'chkEmpHold');"
                                                                                                                                                        type="checkbox">
                                                                                                                                                </HeaderTemplate>
                                                                                                                                                <ItemTemplate>
                                                                                                                                                    <asp:CheckBox ID="chkEmpHold" runat="server" Checked="True" CssClass="chk" name="chkEmpHold"
                                                                                                                                                        onclick="checkUncheckHeaderByRowChk('DvEmp', 'Checkbox1','chkEmpHold');" />
                                                                                                                                                </ItemTemplate>
                                                                                                                                            </asp:TemplateColumn>
                                                                                                                                            <asp:BoundColumn DataField="fk_emp_code" HeaderText="Emp Code" HeaderStyle-Width="7%" />
                                                                                                                                            <asp:BoundColumn DataField="EmpName" HeaderText="Employee Name" HeaderStyle-Width="15%" />
                                                                                                                                            <asp:BoundColumn DataField="Dept_desc" HeaderText="Department" HeaderStyle-Width="15%" />
                                                                                                                                            <asp:BoundColumn DataField="desig_desc" HeaderText="Designation" HeaderStyle-Width="15%" />
                                                                                                                                            <asp:BoundColumn DataField="Email" HeaderText="EmailID" HeaderStyle-Width="18%" />
                                                                                                                                            <asp:BoundColumn DataField="Status" HeaderText="Status" HeaderStyle-Width="10%" />
                                                                                                                                            <asp:BoundColumn DataField="Sent_Date" HeaderText="Last Mail Sent" HeaderStyle-Width="11%" />
                                                                                                                                            <asp:TemplateColumn HeaderText="Preview" HeaderStyle-Width="6%">
                                                                                                                                                <ItemTemplate>
                                                                                                                                                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Preview" CausesValidation="true">
                                                                                                                                                    <img alt="" src="../ImagesCA/formview.ico" border="0" /></asp:LinkButton>
                                                                                                                                                </ItemTemplate>
                                                                                                                                            </asp:TemplateColumn>
                                                                                                                                            <asp:BoundColumn DataField="SalHold" HeaderText="SalHold" Visible="False" />
                                                                                                                                            <asp:BoundColumn DataField="EmpLastName" HeaderText="EmpLastName" Visible="False" />
                                                                                                                                        </Columns>
                                                                                                                                        <PagerStyle CssClass="Datagridpaging" HorizontalAlign="Right" Mode="NumericPages" />
                                                                                                                                    </asp:DataGrid>
                                                                                                                                </div>
                                                                                                                                <asp:Label ID="lblmsg1" runat="server" CssClass="usermessage"></asp:Label>
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                    </table>
                                                                                                                </td>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td>
                                                                                                                    <table id="Table1" border="0" align="center" cellpadding="0" cellspacing="0" width="100%"
                                                                                                                        runat="server">
                                                                                                                        <tr id="Tr2" runat="server">
                                                                                                                            <td colspan="2">
                                                                                                                                <table id="tbl1" runat="server" border="0" cellpadding="3" cellspacing="0" width="100%">
                                                                                                                                    <tr>
                                                                                                                                        <td class="tdcaption" width="12%">
                                                                                                                                            CC
                                                                                                                                        </td>
                                                                                                                                        ...
                                                                                                                                        <td>
                                                                                                                                            <asp:TextBox ID="txtccc" runat="server" CssClass="Textbox" Width="519px"></asp:TextBox>
                                                                                                                                        </td>
                                                                                                                                        <td class="tdvd">
                                                                                                                                            <strong>Note :<span lang="EN-US" style="font-size: 12pt; font-family: Wingdings;
                                                                                                                                            ...
                                                                                                                                            </strong><span style="font-size: 7.5pt; color: black; line-height: 115%; font-family: Verdana;
                                                                                                                                                mso-fareast-font-family: 'Times New Roman'; mso-bidi-font-family: 'Times New Roman';
                                                                                                                                                mso-ansi-language: EN-IN; mso-fareast-language: EN-US; mso-bidi-language: AR-SA">
                                                                                                                                                Max 10 email id’s and use comma as delimiter (separator)</span>
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                                                                                                    <tr>
                                                                                                                                        <td class="tdcaption" width="12%">
                                                                                                                                        ...
                                                                                                                                        <td>
                                                                                                                                            <asp:TextBox ID="txtBCC" runat="server" CssClass="Textbox" Width="519px"></asp:TextBox>
                                                                                                                                        </td>
                                                                                                                                        <td class="tdvd">
                                                                                                                                            <strong>Note :<span lang="EN-US" style="font-size: 12pt; font-family: Wingdings;
                                                                                                                                                mso-ascii-font-family: 'Times New Roman'; mso-fareast-font-family: 'Times New Roman';
                                                                                                                        ...
                                                                                                                        <tr id="trbutton" runat="server">
                                                                                                                            <td style="height: 91px" colspan="2" valign="top">
                                                                                                                                <table id="Table2" border="0" cellpadding="0" cellspacing="0" runat="server" width="100%">
                                                                                                                                    <tr>
                                                                                                                                        <td width="15%"></td>
                                                                                                                                        <td>
                                                                                                                                            <table id="Table3" border="0" cellpadding="0" cellspacing="0" runat="server">
                                                                                                                                                <tr>
                                                                                                                                                    <td valign="tdbetweenbtn" align="left" colspan="8">
                                                                                                                                                        <asp:Button ID="BtnSend" runat="server" CssClass="custombtn" Text="Send email to employees and CC/BCC Email ID’s"
                                                                                                                                                            CausesValidation="True" OnClientClick="javascript:return empchecked('BtnSend',this);"
                                                                                                                                                            Width="300px" style="margin-top: 8px;"></asp:Button>

                                                                                                                                                        <asp:Button ID="btnSave" runat="server" CausesValidation="False" CssClass="custombtn"
                                                                                                                                                            OnClientClick="javascript:return empchecked('btnSave',this);" Text="Publish and generate Zip file"
                                                                                                                                                            ...
                                                                                                                                                            Width="200px" style="margin-top: 8px;" />
                                                                                                                                                        <asp:Button ID="btnPublishedPDF" runat="server" Visible="false" CssClass="btnGreen" ToolTip ="Download Already Published Pay Slips" 
                                                                                                                                                            Text="Download Already Published" Width ="200px" style="margin-top: 8px;" CausesValidation="False"  OnClientClick="return Check4PublishedPayslip();"> </asp:Button>
                                                                                                                                                    
                                                                                                                                                        <asp:Button ID="BtnSendCCBCC" runat="server" CausesValidation="False" CssClass="custombtn"
                                                                                                                                                            Text="Publish and email to CC / BCC" Width="210px" style="margin-top: 8px;" OnClientClick="javascript:return empchecked('BtnSendCCBCC',this);" />
                                                                                                                                                    
                                                                                                                                                        <asp:Button ID="BtnPublishGrpBy" runat="server" CausesValidation="False" CssClass="custombtn"
                                                                                                                                                            OnClientClick="javascript:return empchecked('BtnPublishGrpBy',this);" Text="Unit Wise Publish & Email"
                                                                                                                                                            ToolTip="This action stores the zip file according to unit wise and send email!"
                                                                                                                                                            Width="170px" style="margin-top: 8px;" />

                                                                                                                                                        <asp:Button ID="BtnLog" runat="server" CausesValidation="False" CssClass="custombtn"
                                                                                                                                                            Text="Download Log File" ToolTip="Download text file which employee's already pdf has been generated on server."
                                                                                                                                                            Width="130px" style="margin-top: 8px;" />

                                                                                                                                                        <asp:Button ID="btnWOPWD" runat="server" CausesValidation="False" CssClass="custombtn"
                                                                                                                                                       OnClientClick="javascript:return empchecked('btnSave',this);" Text="Publish Payslip Without Password"
                                                                                                                                                            Width="200px" style="margin-top: 8px;" ToolTip="This button is used by the Admin to download the PDF without password. Salary slip generated will not have any impact of Email, Password and Payslip Publish Mode functionality. Note : Please do not select 'Email sent/Not' functionality while downloading PDF without password." />
                                                                                                                                                ...
                                                                                                                                                <tr>
                                                                                                                                                    <td valign="top" colspan="8">
                                                                                                                                                          <asp:Label ID="lblMsgSlipWOPWD" runat="server" CssClass="usermessage" Font-Bold="True"></asp:Label>
                                                                                                                                                           <asp:Label ID="lblMailMsgWOPWD" runat="server" CssClass="usermessage" Font-Bold="True"></asp:Label>
                                                                                                                                                          <asp:LinkButton ID="LnkPDFWOPWD" runat="server" Style="display: none"><img src="Images/pdf.bmp"  border="0" height="18"></asp:LinkButton>
                                                                                                                                                        <button id="download_pdf2"  runat="server" url="#" onclick ="downloadPdf(event)" style="display:none;border:0;cursor:pointer;" class="btn_pdf">
                                                                                                                                                            <img src="Images/pdf.bmp"  border="0" height="18">
                                                                                                                                                        </button>
                                                                                                                                                ...
                                                                                                                                                <tr>
                                                                                                                                                    <td valign="top" colspan="8">
                                                                                                                                                        <asp:Label ID="lblMsgSlip" runat="server" CssClass="usermessage" Font-Bold="True"></asp:Label>
                                                                                                                                                        <asp:Label ID="lblMailMsg" runat="server" CssClass="usermessage" Font-Bold="True"></asp:Label>
                                                                                                                                                        <asp:LinkButton ID="LnkPDF" runat="server" Style="display: none"><img src="Images/pdf.bmp"  border="0" height="18"></asp:LinkButton>
                                                                                                                                                        <a id="download_pdf" style="display:none" href="#" target="_blank">
                                                                                                                                                            <img src="Images/pdf.bmp"  border="0" height="18">
                                                                                                                                                        </a>

                                                                                                                                                        <button id="download_pdf1"  runat="server" url="#" onclick ="downloadPdf(event)" style="display:none;border:0;cursor:pointer;" class="btn_pdf">
                                                                                                                                                ...
                                                                                                                                                <tr>
                                                                                                                                                    <td valign="top" colspan="7">
                                                                                                                                                        <div id="divProcessBarMsg" style="overflow: auto; max-height: 100px;">
                                                                                                                                                            <asp:Label ID="lblProcessBarMsg" runat="server" CssClass="ErrorMessage" Font-Bold="True"></asp:Label>
                                                                                                                                                        </div>
                                                                                                                                                    </td>
                                                                                                                                                </tr>
                                                                                                                                            </table>
                                                                                                                        ...
                                                                                                                        <tr id="Tr4" runat="server">
                                                                                                                            <td colspan="7">
                                                                                                                                ...
                                                                                                                                <input id="HidEmpCode" type="hidden" runat="server" name="HidEmpCode" />
                                                                                                                                <input id="hidstring1" type="hidden" runat="server" />
                                                                                                                                <input id="HidEmpCodeName" type="hidden" runat="server" name="HidEmpCodeName" />
                                                                                                                                <input id="HidEmpMailCnt" type="hidden" runat="server" name="HidEmpMailCnt" />
                                                                                                                                <input id="HidMailFaildEmpCode" type="hidden" runat="server" name="HidMailFaildEmpCode" />
                                                                                                                                <input id="hidpaycode" type="hidden" name="hidpaycode" runat="server" />
                                                                                                                                <input id="hiddls_selcount" type="hidden" name="hiddls_selcount" runat="server" />
                                                                                                                                <input id="Hidden2" type="hidden" name="HidEmpcode" runat="server" />
                                                                                                                                <input id="Hidden3" type="hidden" name="HidPreVal" runat="server" />
                                                                                                                                <input id="Hidden4" type="hidden" name="HidPreVal" runat="server" />
                                                                                                                                <input id="Hidden5" type="hidden" name="HidPreVal" runat="server" />
                                                                                                                                <input id="hidmonthyear" type="hidden" name="HidPreVal" runat="server" />
                                                                                                                                <input id="HidEmailCCBCC" type="hidden" name="HidPreVal" runat="server" />
                                                                                                                                <input id="HidEmpPdf" type="hidden" runat="server" name="HidEmpPdf" />
                                                                                                                                <input id="HidPdfName" type="hidden" runat="server" name="HidPdfName" />
                                                                                                                                <input id="HidCocManCheck" runat="server" name="HidCocManCheck" type="hidden" />
                                                                                                                                <input id="Hidforecast" type="hidden" name="Hidforecast" runat="server" />
                                                                                                                                <asp:Literal ID="litJava" runat="server"></asp:Literal>
                                                                                                                                <asp:Literal ID="ltrJavaS" runat="server"></asp:Literal>
                                                                                        ...
                                                                                        <Triggers>
                                                                                            ...
                                                                                            <asp:AsyncPostBackTrigger ControlID="BtnSendCCBCC" EventName="Click" />
                                                                                            <asp:PostBackTrigger ControlID="BtnLog" />
                                                                                              <asp:PostBackTrigger ControlID="LnkPDFWOPWD" />
                                                                                        </Triggers>
                                                                                    </asp:UpdatePanel>
                                                                                </td>
                                                                            </tr>
                                                                    ...
                                                                    <input type="hidden" id="hdnBatchId" name="BatchId" runat="server" value="" />
                                                                    <input type="hidden" id="hdnFileFormat" name="FileFormat" runat="server" value="EXCEL" />
                                                                    <input type="hidden" id="hdnAlreadyRunRptId" name="hdnAlreadyRunRptId" runat="server" value="" />
                                                                    <input type="hidden" id="hdnAlreadyRunRptName" name="hdnAlreadyRunRptName" runat="server" value="" />
                                                                    <input type="hidden" id="hdnPGP" name="hdnPGP" runat="server" value="" />
                                                                    <%--<input type="hidden" id="hdnProcessType" name="ProcessType" runat="server" value="" />--%>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
