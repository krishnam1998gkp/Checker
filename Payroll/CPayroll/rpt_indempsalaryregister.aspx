...
<%@ Register Src="~/CPayroll/UsearchWithMultipleEmpCodeproxy.ascx" TagName="ucsearch"
    TagPrefix="uc1" %>
...
<head runat="server">
    ...
    <script language="javascript" src="JavaFiles/ProcessBarYTD.js?v=1.0.3" type="text/javascript"></script>
    <script language="javascript" src="JavaFiles/ReportApiProgressBarScript.js?v=1.1.2" type="text/javascript"></script>
    <style>
        #divSocial img {
            position: relative;
            border: none;
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ShowBalloon(obj, width, height, msg) {
            ...
            b2.Show({ title: String("Instruction"), message: String(msg),
...
<body bottommargin="0" bgcolor="#f7fcff" leftmargin="0" topmargin="0" rightmargin="0"
    ...
    <div id="statusWrapper" style="display: block; line-height: 30px; padding-left: 10px;">
        ...
        <div>
            <span>Estimated time left: </span><span id="estimatedTimeLeft" style="font-weight: bold">
            </span>
        </div>
    </div>
    <div id="summaryWrapper" style="display: none; line-height: 30px; padding-left: 10px;">
        ...
        <div>
            <span>Total employees whose slip not published due to some error: </span><span id="totalUnprocessedSalary"
                style="font-weight: bold"></span>
        </div>
        <div style="display: none;">
            <span>Total employees whose slip already published : </span><span id="TotAlreadyProcssed"
                style="font-weight: bold"></span>
        </div>
        <div>
    ...
    <div id="CommonProgressBarModelElement" class="alt-module-true" style="display: none;">
        <div class="alt-modal dialog-500">
            ...
            <div class="alt-modal-body" id="ErrorWrapper" style="display: none;">
                ...
                <p class="p-lines">
                    <%--<span id="spnerrmsg">Error in Processing the YTD Report, Please connect with App Support</span>--%>
                    <span id="spnerrmsg">Error in Processing the YTD Report, Please refresh the page and try again. If the issue persists, connect with App Support.</span>
                </p>
            </div>
                    ...
                    <tr>
                        <td align="center">
                            <fieldset class="fieldset">
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="98%" align="center" border="0" id="divSocial" runat="server" style="display: none;">
                                            <tr>
                                                <td align="right">
                                                    ...
                                                    <%--<asp:Label ID="lblProcessStatus" runat="server" Text="" ForeColor="Red" Font-Bold="true" style="font-size: 12px;font-family: Verdana, 'Times New Roman', 'Courier New'"></asp:Label>--%>
                                                    <asp:Label ID="lblProcessStatus" runat="server" Text="" CssClass="UserStatusMsg"></asp:Label>
                                                    <asp:ImageButton ID="imgpdfprocess" runat="server" Visible="false" Style="vertical-align: middle;" ToolTip="Refresh" Width="25px" AlternateText="Refresh" ImageUrl="img/refreshtds.gif"></asp:ImageButton>
                                ...
                                <table cellspacing="0" cellpadding="0" width="98%" align="center" border="0" id="divSocialExcel" runat="server" visible="false">
                                    <tr>
                                        <td colspan="3">
                                            <table cellspacing="0" cellpadding="0" width="98%" align="center" border="0">
                                                <tr>
                                                    <td align="right">
                                                        ...
                                                        <asp:ImageButton ID="btnProgressbarExcel" runat="server" Style="vertical-align: middle;" ToolTip="click here to check progress" Width="25px" AlternateText="Refresh" ImageUrl="img/refreshtds.gif" OnClientClick="return PleaseWaitWithDailog();"></asp:ImageButton>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                            ...
                                            <asp:UpdatePanel ID="upd1" runat="server">
                                                <ContentTemplate>
                                                    <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                                                        <tr>
                                                            <td class="TdCaption" colspan="3" valign="middle">
                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                    <tr class="trupbtn">
                                                                        <td colspan="3" class="trbtnup"></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="TdCaption" width="12%" valign="middle"></td>
                                                                        <td class="TDcolon" valign="middle"></td>
                                                                        <td colspan="3">
                                                                            <asp:Button ID="btnEdit" runat="server" class="btn" Text="EDIT" OnClientClick="javascript:return BtnHidenShow();" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="TdCaption" valign="middle" width="12%">From date</td>
                                                                        <td class="TDcolon" valign="middle">:</td>
                                                                        <td>
                                                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                                <tr id="PnlSMonth" runat="server" style="display: none">
                                                                                    <td width="36.5%" valign="middle">
                                                                                        <asp:DropDownList ID="ddlmonth" runat="server" CssClass="dropdownlist"></asp:DropDownList>
                                                                                    </td>
                                                                                    <td class="TdCaption" width="14%" valign="middle">To date</td>
                                                                                    <td class="TDcolon" valign="middle">:</td>
                                                                                    <td colspan="2" valign="middle">
                                                                                        <asp:DropDownList ID="ddlmonth1" runat="server" CssClass="dropdownlist"></asp:DropDownList>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr id="PnlAfromdatatodate" runat="server" style="display: none">
                                                                                    <td valign="middle" width="36.5%">
                                                                                        <asp:DropDownList ID="ddlASmonth" runat="server" CssClass="dropdownlist"></asp:DropDownList>
                                                                                    </td>
                                                                                    <td class="TdCaption" valign="middle" width="14%">To date</td>
                                                                                    <td class="TDcolon" valign="middle">:</td>
                                                                                    <td colspan="2" valign="middle">
                                                                                        <asp:DropDownList ID="ddlAEmonth" runat="server" CssClass="dropdownlist" DataMember="dropdownlist"></asp:DropDownList>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                    ...
                                                                    <tr id="TrFormat" runat="server" style="display: none;">
                                                                        <td class="TdCaption" width="12%" valign="middle">View Format</td>
                                                                        <td class="TDcolon" valign="middle">:</td>
                                                                        <td colspan="3">
                                                                            <asp:RadioButtonList ID="rbtnreportformate" runat="server" CssClass="HospRadiobuttonlist" RepeatDirection="Horizontal" onchange="CheckChange();">
                                                                                <asp:ListItem Selected="True" Value="H">Horizontal</asp:ListItem>
                                                                                <asp:ListItem Value="V">Vertical</asp:ListItem>
                                                                            </asp:RadioButtonList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr id="TrExtrapolate" runat="server" style="display: none;">
                                                                        <td class="TdCaption" width="12%" valign="middle">Extrapolate</td>
                                                                        <td class="TDcolon" valign="middle">:</td>
                                                                        <td>
                                                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                                <tr>
                                                                                    <td width="10%" valign="middle">
                                                                                        <asp:RadioButtonList ID="rblextrapolate" runat="server" AutoPostBack="True" CssClass="HospRadiobuttonlist" RepeatDirection="Horizontal" onchange="PleaseWaitWithDailog();">
                                                                                            <asp:ListItem Selected="True" Value="N">No</asp:ListItem>
                                                                                            <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                                                        </asp:RadioButtonList>
                                                                                    </td>
                                                                                    <td width="26.5%" valign="middle">
                                                                                        <img id="Instruction" style="cursor: hand" alt="" onclick="ShowBalloon(this,600,70,'<strong>1. Horizontal: </strong>Display months row wise<br /><strong>2</strong>. <strong>Vertical: </strong>Display months column wise<br /><strong>3. Extrapolate</strong>: Projected salary')" src="ImagesCA/new4-0985.gif" />
                                                                                    </td>
                                                                                    <td class="TdCaption" width="14%" valign="middle">Show Arrear in Same Month</td>
                                                                                    <td class="TDcolon" valign="middle">:</td>
                                                                                    <td valign="TDVd">
                                                                                        <asp:CheckBox ID="chkArrSmeMnth" runat="server" CssClass="Checkbox" /></td>
                                                                                    <td class="Message">
                                                                                        <asp:Literal ID="Literal2" runat="server" Text="use for Excel,CSV."></asp:Literal></td>
                                                                        </td>
                                                                    </tr>
                                                        ...
                                                        <tr id="Trpublish" runat="server" style="display: none;">
                                                            <td class="TdCaption" style="width: 12%">Publish per page</td>
                                                            <td class="TDcolon">:</td>
                                                            <td>
                                                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                    <tr>
                                                                        <td class="TDVd" style="width:36.5%">
                                                                            <asp:TextBox ID="txtpagevalue" runat="server" CssClass="textbox" oninput="checkvals()" MaxLength="2" Columns="3"></asp:TextBox>*
                                                                        </td>
                                                                        <td>
                                                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                                <tr id="trRepIn" style="display: none" runat="server">
                                                                                    <td class="TdCaption" style="width:22%">Report In</td>
                                                                                    <td class="TDcolon" style="width:5%">:</td>
                                                                                    <td class="TDVd">
                                                                                        <asp:DropDownList ID="ddlreportIn" runat="server" CssClass="DropdownList"  onchange="validatePswd();">
                                                                                            <asp:ListItem Text="PDF" Value="P"></asp:ListItem>
                                                                                            <asp:ListItem Text="HTML" Value="H"></asp:ListItem>
                                                                                        </asp:DropDownList>
                                                                                        (PDF: In PDF report will be generated employee wise.)
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                        ...
                                                        <tr id="trpswd" style="display: none" runat="server">
                                                            ...
                                                            <td class="tdvd">
                                                                 <asp:DropDownList ID="ddlEmpPass" runat="server" CssClass="dropdownlist" Enabled="true">
                                                                    ...
                                                                    <asp:ListItem Text="Pan No." Value="2"></asp:ListItem>
                                                                    <asp:ListItem Text="First Name & DOB" Value="3"></asp:ListItem>
                                                                    <asp:ListItem Text="Bank A/C No. & DOB" Value="4"></asp:ListItem>
                                                                    <asp:ListItem Text="First Name & DOB(DDMMYYYY)" Value="5"></asp:ListItem>
                                                                      <asp:ListItem Text="Pan No. & DOB(DDMMYY)" Value="6"></asp:ListItem>
                                                                      <asp:ListItem Text="Emp. Code & DOB(DDMMYY)" Value="7"></asp:ListItem>
                                                                  </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                        <tr id="TrEmpDetails" runat="server" style="display: none;">
                                                            ...
                                                            <td class="TdColon">:</td>
                                                            <td class="tdvd">
                                                            <table id="Table2" cellpadding="0" cellspacing="0" border="0" runat="server" width="100%">
                                                            <tr>
                                                             <td class="tdvd" width="60%">
                                                                <div style="border:1px;border-color:Blue;Width:600px;border-style:solid;height:50px">
                                                                    <asp:CheckBoxList ID="chkEmpdet" RepeatDirection="Horizontal" RepeatColumns="5" runat="server" CssClass="chkList" Width="600px"></asp:CheckBoxList>    
                                                                </div>
                                                                </td>
                                                                <td class="TDCaption"><img src="ImagesCA/Note.gif" border="0" /></td>
                                                                <td class="Message" width="40%">
                                                                <asp:Literal ID="Literal1" runat="server" Text="In excel report all the data (Costcenter,Location,Unit,Designation,Department, Level,Grade,DOJ,DOL) will populate always, only PAN is configurable."></asp:Literal></td>
                                                            </tr>
                                                            </table>
                                                        ...
                                                        <tr id="TrSave" runat="server">
                                                            <td class="TDCaption" style="width: 12%"><input type="hidden" runat="server" id="hidEmpCode" /></td>
                                                            <td class="TdColon"></td>
                                                            <td>
                                                                <table id="Table1" cellspacing="0" cellpadding="0" border="0">
                                                                    <tr>
                                                                        <td class="tdbetweenbtn">
                                                                         <asp:Button ID="btnDownloadCSV" runat="server" Visible="false" CssClass="btn" ToolTip ="Download in CSV format" Text="EXPORT TO CSV" Width ="120px" CausesValidation="False" OnClientClick="javascript:return OnClickDownloadCSV();"> </asp:Button>  
                                                                        </td>
                                                                        <td class="tdbetweenbtn"></td>
                                                                        <td class="tdbetweenbtn">
                                                                            <asp:Button ID="btnexcel" runat="server" CausesValidation="False" CssClass="btn" Text="EXPORT TO EXCEL" Width="120px" OnClientClick="javascript:return btnExcel_Click();"/>
                                                                        </td>
                                                                        <td class="tdbetweenbtn"></td>
                                                                        <td valign="tdbetweenbtn">
                                                                            <asp:Button ID="btnPriview" runat="server" class="btn" Text="Preview" Width="100px" OnClientClick="return LoadProcessDialog();" />
                                                                            <asp:HiddenField ID="hdf_USearchMulti_DdlCostCenter" runat="server" Value="" />
                                                                            <asp:HiddenField ID="hdf_USearchMulti_DdlDept" runat="server" Value="" />
                                                                            <asp:HiddenField ID="hdf_USearchMulti_ddllocation" runat="server" Value="" />
                                                                            <asp:HiddenField ID="hdf_USearchMulti_ddldesignation" runat="server" Value="" />
                                                                            <asp:HiddenField ID="hdf_USearchMulti_ddlunit" runat="server" Value="" />
                                                                            <asp:HiddenField ID="hdf_USearchMulti_ddlGrade" runat="server" Value="" />
                                                                            <asp:HiddenField ID="hdf_USearchMulti_ddllevel" runat="server" Value="" />
                                                                        </td>
                                                                        <td class="tdbetweenbtn"></td>
                                                                        <td valign="tdbetweenbtn">
                                                                            <asp:Button ID="btnPublishedPDF" runat="server" Visible="true" CssClass="btn" ToolTip="Download Already Published YTD Slips" Text="Download Already Publish YTD Slips" Width="250px" CausesValidation="False" OnClientClick="return PleaseWaitWithDailog();"></asp:Button>
                                                                        </td>
                                                                        <td class="tdbetweenbtn"></td>
                                                                        <td valign="tdbetweenbtn">
                                                                            <asp:Button ID="btnReset" runat="server" CssClass="btn" Text="Reset" CausesValidation="False" OnClientClick="PleaseWaitWithDailog();"> </asp:Button>
                                                                        </td>
                                                                    ...
                                                                    <tr id="tdDwn" style="Display:none;" runat="server">
                                                                        <td class="TDVd" colspan="7">
                                                                            <span id="spnmsgtolink" runat="server">Click to PDF icon to download the .zip file.</span>
                                                                            <asp:LinkButton ID="LnkPDF" runat="server" ><img src="Images/pdf.bmp"  border="0" height="18"></asp:LinkButton>
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="trupbtn">
                                                                        <td colspan="7" class="trbtnup"></td>
                                                        ...
                                                        <tr id="TrSvConfig" runat ="server" style="Display:none;">
                                                            ...
                                                            <td class="TdColon"></td>
                                                            <td colspan="3">
                                                                <asp:Button ID="btnSaveConfig" CssClass="btn" CausesValidation="false" runat="server"
                                                                    Text="Save Configuration" Width="120px" OnClientClick="PleaseWaitWithDailog();"></asp:Button>
                                                                ...
                                                                <input type="hidden" runat="server" id="HidEmpCodes4Pdf" />
                                                            </td>
                                                            <td></td>
                                                        </tr>
                                                        ...
                                                        <tr id="trAlreadyReg" runat="server" visible="false">
                                                            ...
                                                            <td class="TdColon">:</td>
                                                            <td class="tdvd">
                                                                <span id="spnAlreadyYTDGenerated" runat="server" class="UserPrevRunMsg"></span>
                                                                <asp:LinkButton ID="lnkAlreadyYTDGenerated" runat="server" OnClientClick="return PleaseWaitWithDailog();" ToolTip="Click here to download already generated Year to Date Register"><img src="Images/Excel_img.jpg"  border="0" height="18"></asp:LinkButton>
                                                                <br />
                                                                <span id="spnAlreadyYTDGeneratedEnd" runat="server" class="UserPrevRunMsg"></span>
                                                                <input type="hidden" runat="server" id="hdnYtdRegPath" />
                                                                <input type="hidden" runat="server" id="hdnYtdRegFileName" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </ContentTemplate>
